...
func InitOptionMap() {
	...
	common.OptionMap["PayosReturnURL"] = setting.PayosReturnURL
	common.OptionMap["PayosCancelURL"] = setting.PayosCancelURL
	...
	common.OptionMap["NowpaymentsApiUrl"] = setting.NowpaymentsApiUrl
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "PayosReturnURL":
		setting.PayosReturnURL = value
	case "PayosCancelURL":
		setting.PayosCancelURL = value
	case "PayosUnitPrice":
		setting.PayosUnitPrice, _ = strconv.ParseFloat(value, 64)
	case "PayosMinTopUp":
		setting.PayosMinTopUp, _ = strconv.Atoi(value)
	case "NowpaymentsApiUrl":
		setting.NowpaymentsApiUrl = value
