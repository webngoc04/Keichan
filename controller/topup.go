...
func GetTopUpInfo(c *gin.Context) {
	...
	// Crypto (NOWPayments) is intentionally prepended so it renders before
	// every other method; PayOS (VN bank QR) follows.
