...
export type NavigateFn = (opts: any) => Promise<void> | void | Promise<any>
...
export function useTableUrlState(
  ...
  const safeSearch = (search ?? {}) as SearchRecord
  ...
  }, [safeSearch, pageKey, pageSizeKey, defaultPage, defaultPageSize])
