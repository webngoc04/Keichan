...
function OverviewSummaryGrid(props: { model: PricingModel }) {
  ...
  return (
    <div className='bg-muted/20 grid grid-auto-3 overflow-hidden rounded-lg border divide-x'>
      <OverviewMetric
        icon={Timer}
        label='TPS'
  ...
  return (
    <section>
      ...
      <div className='grid gap-3 rounded-xl border p-3 @2xl/details:grid-cols-[minmax(0,1.5fr)_minmax(260px,1fr)]'>
        ...
        {(inputModalities.length > 0 || outputModalities.length > 0) && (
          <div className='grid gap-2 grid-auto-2'>
            {inputModalities.length > 0 && (
...
function ModelBackendProviderSection(props: { model: PricingModel }) {
  ...
  return (
    <section>
      ...
      <div className='border-border/60 bg-border/60 grid grid-auto-2 gap-px overflow-hidden rounded-lg border'>
        {cells}
      </div>
    </section>
  )
  ...
  return (
    <header className='pb-4'>
      <div className='flex items-center gap-2.5'>
        {modelIcon}
        <h1 className='font-mono text-fluid-h1 font-bold tracking-tight'>
          {model.model_name}
        </h1>
        <CopyButton
    ...
    return (
      <PublicLayout>
        <div className='mx-auto max-w-5xl px-4 sm:px-6'>
          ...
          <div className='mt-6 grid grid-auto-4 gap-2'>
